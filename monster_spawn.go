...
var FloorSpawnTables = map[int][]MonsterSpawnEntry{
	...
	2: {{0, 20}, {2, 20}, {1, 20}, {3, 20}, {4, 10}, {7, 10}}, // 2階: ハリセンボウとコソドロヤドカリが登場
	3: {{0, 5}, {2, 5}, {1, 20}, {3, 20}, {4, 10}, {5, 15}, {7, 10}, {8, 10}, {9, 5}},
	4: {{1, 10}, {3, 10}, {4, 10}, {5, 15}, {6, 15}, {7, 10}, {8, 10}, {9, 10}, {10, 10}}, // 4階以降: 4種の所持品干渉敵が揃う
}
