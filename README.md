...
- 武器: こん棒、長巻、どうたぬき
- 防具: 木甲の盾、鉄甲の盾、皮甲の盾
- 敵: マムル、くねくねハニー（鈍足攻撃）、ハリセンボウ（直線射撃）、イシガニ（障害物越しの投石）、バクダンウニ（範囲爆発）、コソドロヤドカリ（盗品を持って逃走）、にぎりエビ（所持品を食料化）、ノロイガニ（装備を呪う）、あやつりクラゲ（道具使用・移動を強制）、ユウレイエビ（壁抜け）、ハヤテシャコ（倍速）、ワープクラゲ（ワープ）、イレカエダコ（場所替え）、ワナシヤドカリ（罠生成）、化け貝（道具・階段への擬態）
- 罠: 睡眠ガス、毒矢、鈍足、地雷
